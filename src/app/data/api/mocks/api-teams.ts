export const TEAMS_MOCK = [
  ...
  },
  {
    ...
    'code': null,
    'shortName': 'Boavista',
    'squadMarketValue': '16,525,000 €',
    'crestUrl': 'http://upload.wikimedia.org/wikipedia/en/4/40/Boavista_F.C._logo.svg'
  },
  {
    '_links': {
      'self': {'href': 'http://api.football-data.org/v1/teams/1052'},
      'fixtures': {'href': 'http://api.football-data.org/v1/teams/1052/fixtures'},
      'players': {'href': 'http://api.football-data.org/v1/teams/1052/players'}
    },
    'name': 'União Madeira',
    'code': null,
    'shortName': 'Madeira',
    'squadMarketValue': '9,550,000 €',
    'crestUrl': 'https://upload.wikimedia.org/wikipedia/en/0/0f/UMadeira.png'
  },
  {
    '_links': {
  ...
  },
  {
    ...
    'code': null,
    'shortName': 'Ferreira',
    'squadMarketValue': '18,600,000 €',
    'crestUrl': 'http://upload.wikimedia.org/wikipedia/de/f/f2/FC_Pacos_de_Ferreira.svg'
  },
  {
    '_links': {
      'self': {'href': 'http://api.football-data.org/v1/teams/509'},
      'fixtures': {'href': 'http://api.football-data.org/v1/teams/509/fixtures'},
      'players': {'href': 'http://api.football-data.org/v1/teams/509/players'}
    },
    'name': 'Académica de Coimbra',
    'code': null,
    'shortName': 'Academica',
    'squadMarketValue': '19,850,000 €',
    'crestUrl': 'http://upload.wikimedia.org/wikipedia/de/b/b8/Logo_Academica_de_Coimbra.svg'
  }
];
