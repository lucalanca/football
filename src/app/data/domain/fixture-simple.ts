...
export class FixtureSimple {
  constructor(
      public id: number, public date: string, public status: string, public matchday: number,
      public goalsHomeTeam: number, public goalsAwayTeam: number, public homeTeam: ITeamSimple,
  ...
  //       APIHelpers.getIdFromUrl(fixtureObj._links.self.href), fixtureObj.date, fixtureObj.status,
  //       fixtureObj.matchday, fixtureObj.result.goalsHomeTeam, fixtureObj.result.goalsAwayTeam,
  //       homeTeam, awayTeam);
  // }
}
