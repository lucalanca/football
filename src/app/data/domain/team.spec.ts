...
describe('Team ', () => {
  it('constructs a team using the class constructor (without players)', () => {
    var t = new Team(
        503, 'FC Porto', 'Porto', 'FCP', '150,850,000 €',
  ...
  //     }
  //   ];
  //   var players: Player[] = PLAYERS_MOCK.map((obj) => { return Player.createFromObject(obj); });
  //
  //   var t = new Team(
  //       503, 'FC Porto', 'Porto', 'FCP', '150,850,000 €',
  //       'http://upload.wikimedia.org/wikipedia/de/e/ed/FC_Porto_1922-2005.svg', players);
  //
  //   expect(t.id).toBe(503);
  //   expect(t.name).toBe('FC Porto');
  //   expect(t.shortName).toBe('Porto');
  ...
  //   expect(t1.crestUrl)
  //       .toBe('http://upload.wikimedia.org/wikipedia/de/e/ed/FC_Porto_1922-2005.svg');
