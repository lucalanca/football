import {IAPILink, ITeamAPIObject, APIHelpers, IFixtureSimpleAPIObject} from './api';
...
export class Season {
  ...
  static createFromObject(seasonObj: ISeasonAPIObject,
                          teamsObjsArr: ITeamAPIObject[] = [],
    ...
    return new Season(
      ...
      seasonObj.league,
      seasonObj.year,
      seasonObj.currentMatchday,
      seasonObj.numberOfMatchdays,
      seasonObj.numberOfTeams,
      seasonObj.numberOfGames,
      teams,
      fixtures
    );
  }
  ...
  getCurrentMatchday () {
    return this.getMatchdayFixtures(this.currentMatchday);
  }
